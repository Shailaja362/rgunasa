    ...
    <form id="programmeForm" method="POST" enctype="multipart/form-data" class="space-y-4 mt-8 px-3">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="programme_name" value="{{ $edit_programme->name ?? '' }}"
                    id="programme_name" placeholder="Enter your Programme Name"
            ...
            <div>
                ...
                <input type="text" name="programme_code" value="{{ $edit_programme->code ?? '' }}"
                    id="programme_code" placeholder="Enter your Department Code"
                    class="w-full bg-[#D9D9D9] rounded-full px-4 py-2 mt-1 focus:outline-none focus:ring focus:ring-primary/40">
            </div>
        </div>
        ...
        <div class="flex justify-center mt-10">
            <button type="submit" id="programme"
